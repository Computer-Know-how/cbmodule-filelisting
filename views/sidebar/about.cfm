<cfoutput>
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<a href="https://compknowhow.com" target="_blank" title="Your ColdBox and ContentBox specialists.">
			<div class="center"><img src="#event.getModuleRoot('fileListing')#/includes/images/logo.png" alt="Computer Know How, LLC" border="0" /></a><br/></div>
